...
Bienvenido a este vídeo sobre la creación e interpretación de informes de DIY Loop
a través de Nightscout.
Los vídeos anteriores han cubierto los pasos para crear un sitio web Nightscout y
conectar tu aplicación DIY Loop a Nightscout para la transmisión de datos cada 5
minutos.
En este vídeo trataremos los siguientes temas:
- Qué información puedes encontrar en Nightscout
- Los distintos informes disponibles en Nightscout
- Y cómo interpretar eficazmente estos informes
Al final de este video, usted tendrá una comprensión completa de cómo acceder y
utilizar los informes en Nightscout, lo que le permite tomar decisiones informadas
sobre el control de su diabetes.
...
utilizan raramente. Dependiendo de su estado de autenticación, también verá
un signo más, donde puede iniciar sesión en los tratamientos.
2.​ La sección de información del sistema muestra la información actual de todos
los sistemas conectados a Nightscout. Puede incluir cajas grises o plugins,
que proporcionan detalles adicionales cuando se pasa el ratón por encima.
En Nightscout llamamos a estas pastillas.
3.​ La sección de información sobre el usuario y el tratamiento muestra
información sobre usted y sus tratamientos. Encontrarás pastillas o
abreviaturas que se explicarán con más detalle en la sección de ajustes.
4.​ La sección de insulina basal muestra tu liberación basal de insulina.
5.​ La sección de glucosa del sensor y tratamientos muestra las lecturas de
glucosa de tu sensor, los tratamientos con carbohidratos y/o insulina, así
como las predicciones de DIY Loop.
6.​ Esta sección del historial de datos muestra las últimas 48 horas de datos.
...
-​ A través del Perfil y el Editor de comida puedes cambiar los ajustes, aunque
normalmente se gestionan a través de la aplicación DIY Loop en lugar de
Nightscout.
...
-​ La configuración de la cuenta ofrece opciones para ajustar las unidades, el
formato de hora, el idioma, etc. También puedes personalizar la apariencia de
tu cuenta Nightscout, incluyendo la visualización de plugins o pastillas.
Además, esta sección explica las abreviaturas utilizadas en la interfaz.

-​ Los cambios se pueden guardar si introduce su contraseña API. Debajo
puede ver el estado de autenticación.
Explorando estas opciones y realizando los ajustes apropiados, puedes personalizar
tu experiencia Nightscout para adaptarla a tus necesidades.
5.2 Tipos de informes
Si utilizas DIY Loop, puedes acceder a los informes a través de tu sitio web
...
deseado, pulsa "Ctrl+P" (o Comando+P en un ordenador Mac) y selecciona
...
Mediante el uso eficaz de Nightscout y Nightscout Reporter, puede proporcionar a
su proveedor de atención sanitaria informes completos que destaquen el
rendimiento y las tendencias de su control de la diabetes con DIY Loop.
5.3 Interpretación de los informes
En DIY Loop, los principales parámetros que se pueden ajustar son el valor objetivo
o Rango de Corrección, el ratio de carbohidratos, la tasa de insulina basal y la
sensibilidad a la insulina. Esto se puede hacer a través de los Ajustes de Terapia en
la app DIY Loop.
Puede ser útil seguir un enfoque estructurado a la hora de interpretar los informes y
realizar ajustes. Aquí tienes una guía detallada:
